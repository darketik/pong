...
xst -ifn xst.scr
move clkgen_dcm_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\clkgen_dcm_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clkgen_dcm_exdes.ucf clkgen_dcm_exdes

echo 'Running map'
map -timing -pr b clkgen_dcm_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm clkgen_dcm_exdes -w routed.ncd routed.vhd
cd ..
